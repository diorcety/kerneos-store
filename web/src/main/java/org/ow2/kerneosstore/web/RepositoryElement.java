...
import org.ow2.kerneosstore.web.util.AnyElementMapAdapter;
...
public class RepositoryElement implements Repository {
    private Long id;
    private String name;
    private String type;
    ...
    public RepositoryElement(Repository repository) {
        id = repository.getId();
