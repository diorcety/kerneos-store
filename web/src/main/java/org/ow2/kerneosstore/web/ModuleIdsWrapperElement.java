...
public class ModuleIdsWrapperElement implements ModuleIdsWrapper {

    @XmlElementWrapper(name = "idsCollection")
    @XmlElement
    private Collection<String> ids;

    public ModuleIdsWrapperElement() {
    }

    public ModuleIdsWrapperElement(ModuleIdsWrapper moduleIdsWrapper) {
