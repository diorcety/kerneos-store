...
@Provider
public class ModuleReader implements MessageBodyReader<ModuleVersion> {
    @Context
    Providers providers;

    @Override
    public boolean isReadable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
        return ModuleVersion.class.equals(type);
    }

    @Override
    public ModuleVersion readFrom(Class<ModuleVersion> type, Type genericType, Annotation[] annotations, MediaType mediaType, MultivaluedMap<String, String> httpHeaders, InputStream entityStream) throws IOException, WebApplicationException {
